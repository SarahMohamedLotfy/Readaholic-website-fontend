...
describe('HttpsearchpeopleService', () => {
  let service: HttpsearchpeopleService;
  ...
  beforeEach( () =>  {
    ...
    providers: [HttpsearchpeopleService],
  });
  service = TestBed.get(HttpsearchpeopleService);
  ...
  it('should be created', () => {
    const service: HttpsearchpeopleService = TestBed.get(HttpsearchpeopleService);
