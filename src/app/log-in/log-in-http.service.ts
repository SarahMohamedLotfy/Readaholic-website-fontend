...
@Injectable({
 ...
 {
   return this.http.post('http://ec2-3-87-221-152.compute-1.amazonaws.com/login',{email,password}) ;
 }
...
/**Sends a request to server with the variables that user entered to sign up a new user */
 ...
 {
   return this.http.post('http://ec2-3-87-221-152.compute-1.amazonaws.com/signup',{email,password,password_confirmation,name,gender,birthday,country,city}) ;
 }
/**Loggs out the user from the website */
 logOut():Observable<any>{
    return this.http.delete('http://ec2-3-87-221-152.compute-1.amazonaws.com/logout');
  }
  }
